    ...
    <div className="min-h-screen bg-[#050816] px-5 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-[#0a0f20] border border-gray-800 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative z-10">
        ...
        <form className="space-y-5" onSubmit={onSubmit}>
          ...
          <button disabled={loading} className="w-full py-4 bg-[#21B7E2] text-[#050816] font-black rounded-2xl shadow-xl shadow-cyan-500/20 hover:bg-blue-500 transition-all text-lg disabled:opacity-50">
        ...
        <button onClick={googleLogin} className="w-full py-4 bg-[#050816] border border-gray-800 text-white rounded-2xl hover:bg-sky-800 hover:text-[#050816] transition-all font-bold flex items-center justify-center gap-3">
