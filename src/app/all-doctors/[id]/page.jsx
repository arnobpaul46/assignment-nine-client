...
import { Star, MapPin, Briefcase, Building, Clock, CalendarCheck, Wallet } from 'lucide-react';
            ...
            <div className="max-w-[90%] lg:max-w-[80%] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 flex flex-col justify-center">
                        ...
                        <button className="bg-[#21B7E2] hover:bg-white text-[#050816] w-full md:w-fit px-8 py-4 rounded-2xl font-black text-lg transition-all shadow-xl shadow-cyan-500/10 active:scale-95">
                            Book Appointment
                        </button>
